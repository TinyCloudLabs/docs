---
title: "DID Formats"
description: "Understanding primary and session DIDs in TinyCloud"
icon: "fingerprint"
---
...
console.log(tc.did);
// did:pkh:eip155:1:0x1234...abcd (primary DID)
...
After signIn, the `.did` property returns your primary DID. This is the DID others should use when creating delegations to you. A delegation targeting a session key DID will always fail because:
