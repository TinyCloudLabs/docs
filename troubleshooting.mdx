...
<AccordionGroup>
  ...
  <Accordion title="Old session invalid after update">
    ...
    **Cause**: The terminology migrations from "orbit" to "namespace" (December 2025), then "namespace" to "space" (January 2026) invalidated sessions stored with the old `orbitId` or `namespaceId` fields.
    ...
    **Solution**: Clear persisted sessions and re-authenticate:
    ...
    This is a one-time migration. New sessions use the `spaceId` field and will persist correctly.
  </Accordion>
</AccordionGroup>
