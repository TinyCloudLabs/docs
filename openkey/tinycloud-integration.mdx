...
Pass the `OpenKeyEIP1193Provider` directly to TinyCloudWeb — the SDK handles ethers wrapping internally.
...
| **TinyCloud compatibility** | Native | Via OpenKeyEIP1193Provider |
