...
<CardGroup cols={2}>
  <Card title="TEE Key Generation" icon="cpu">
  ...
  <Card title="Message Signing" icon="pen-tool">
  ...
  <Card title="Embeddable Widget" icon="app-window">
...
<Frame>
  <img src="/images/diagrams/openkey-architecture.svg" alt="OpenKey architecture - client, TEE, and database" />
</Frame>
...
OpenKey OAuth is a separate flow for token-based access to your own application. Use [TinyCloud Integration](/openkey/tinycloud-integration) when you want OpenKey to sign TinyCloud's SIWE session flow, and use [OAuth Provider](/openkey/oauth) when you need OAuth 2.1 tokens.
